...
INSERT INTO `user` VALUES (1,11429395,'Re5tart',4,'jared_kabusuan@dlsu.edu.ph','09382904103',0,0,'Jared','L','Kabusuan','03/29/1997','What is your first pet\'s name?','Gorgos'),(2,20092140,'KR!ng3',3,'jerry.mangan@dlsu.edu.ph','09837548783',0,0,'Jerry','K.','Mangan','09/29/1989','Which street did you live in when you were 5 year old?','Maginhawa Street'),(3,20013334,'D@ngerous',2,'danny.lopez@dlsu.edu.ph','09299990987',0,0,'Danny','S.','Lopez','02/12/1979','How much is your first income?','5,432Pesos'),(4,20038931,'D00mHamm3r',1,'ogrim.manalo@dlsu.edu.ph','09339209399',0,0,'Ogrim','K.','Manalo','01/20/1990','What is the first console game that you played?','Sonic Adventure'),(5,11354069,'H0wL0ng',4,'maria_karaga@dlsu.edu.pg','09253253554',0,0,'Maria','J.','Karaga','02/11/1996','What is your first pet\'s name?','Mandy');
...
-- Dump completed on 2017-08-09 17:28:22
